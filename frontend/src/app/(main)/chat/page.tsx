        ...
        <div className="space-y-1">
          {data.data.map((room) => (
            ...
            >
              ...
              {room.unreadCount ? (
                <span className="bg-gray-900/15 text-gray-900 dark:bg-white/15 dark:text-white text-xs w-5 h-5 rounded-full flex items-center justify-center shrink-0 font-medium">
